...
CString dmsoft::AiFindPicMemEx(long x1,long y1,long x2,long y2,const TCHAR * pic_info,double sim,long dir)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
    ...
    if (dispatch_id == -1)
    {
        spDisp.GetIDOfName(L"AiFindPicMemEx",&dispatch_id);
    }
...
long dmsoft::AiYoloDetectObjectsToDataBmp(long x1,long y1,long x2,long y2,double prob,double iou,long * data,long * size,long mode)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString dmsoft::AiFindPicEx(long x1,long y1,long x2,long y2,const TCHAR * pic_name,double sim,long dir)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
    ...
    if (dispatch_id == -1)
    {
        spDisp.GetIDOfName(L"AiFindPicEx",&dispatch_id);
    }
...
long dmsoft::AiEnableFindPicWindow(long enable)
{
    ...
    if (dispatch_id == -1)
    {
        spDisp.GetIDOfName(L"AiEnableFindPicWindow",&dispatch_id);
    }
...
long dmsoft::SetReadDataMemoryData(LONGLONG addr,long length)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
    ...
    if (dispatch_id == -1)
    {
        spDisp.GetIDOfName(L"SetReadDataMemoryData",&dispatch_id);
    }
...
long dmsoft::AiYoloDetectObjectsToFile(long x1,long y1,long x2,long y2,double prob,double iou,const TCHAR * file_name,long mode)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString dmsoft::AiYoloDetectObjects(long x1,long y1,long x2,long y2,double prob,double iou)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long dmsoft::SetAsmHwndAsProcessId(long en)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
    ...
    if (dispatch_id == -1)
    {
        spDisp.GetIDOfName(L"SetAsmHwndAsProcessId",&dispatch_id);
    }
...
long dmsoft::AiFindPic(long x1,long y1,long x2,long y2,const TCHAR * pic_name,double sim,long dir,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
    ...
    if (dispatch_id == -1)
    {
        spDisp.GetIDOfName(L"AiFindPic",&dispatch_id);
    }
...
long dmsoft::AiFindPicMem(long x1,long y1,long x2,long y2,const TCHAR * pic_info,double sim,long dir,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
    ...
    if (dispatch_id == -1)
    {
        spDisp.GetIDOfName(L"AiFindPicMem",&dispatch_id);
    }
...
long dmsoft::SetSendStringDelay(long delay)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
    ...
    if (dispatch_id == -1)
    {
        spDisp.GetIDOfName(L"SetSendStringDelay",&dispatch_id);
    }
