...
public:
	...
	//设置数值
	UINT SetBool(LPCTSTR pszItem, LPCTSTR pszSubItem, bool bValue);
	UINT SetInt(LPCTSTR pszItem, LPCTSTR pszSubItem, int iValue);
	UINT SetString(LPCTSTR pszItem, LPCTSTR pszSubItem, LPCTSTR pszDefault);
